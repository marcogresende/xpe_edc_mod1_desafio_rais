...
sagemaker_role='arn:aws:iam::377000241855:role/service-role/AmazonSageMaker-ExecutionRole-20210518T105032'
...
def handler(event, context):
    ...
    process_job_arn = sageclient.create_processing_job(
            ...
            'Outputs': [
                {
                    'OutputName': 'rais',
                    'S3Output': {
                        'S3Uri': 's3://xpe-marco-rais-prod-landing-zone-377000241855/rais',
        ...
        AppSpecification={
            'ImageUri': '377000241855.dkr.ecr.us-east-2.amazonaws.com/xpe-marco-prod-extract-rais:latest'
        },
